...
extern "C" {
    ...
    pub fn fftw_plan_many_dft(rank: c_int, n: *c_int, howmany: c_int,
                              ...
                              flags: c_uint) -> fftw_plan;
    pub fn fftw_plan_guru_dft(rank: c_int, dims: *fftw_iodim,
                              howmany_rank: c_int, howmany_dims: *fftw_iodim,
                              _in: *mut fftw_complex, out: *mut fftw_complex,
                              sign: c_int, flags: c_uint) -> fftw_plan;
    pub fn fftw_plan_guru_split_dft(rank: c_int, dims: *fftw_iodim,
                                    howmany_rank: c_int,
                                    howmany_dims: *fftw_iodim,
                                    ri: *mut c_double, ii: *mut c_double,
                                    ro: *mut c_double, io: *mut c_double,
                                    flags: c_uint) -> fftw_plan;
    pub fn fftw_plan_guru64_dft(rank: c_int, dims: *fftw_iodim64,
                                howmany_rank: c_int,
                                howmany_dims: *fftw_iodim64,
                                _in: *mut fftw_complex,
                                out: *mut fftw_complex, sign: c_int,
                                flags: c_uint) -> fftw_plan;
    pub fn fftw_plan_guru64_split_dft(rank: c_int, dims: *fftw_iodim64,
                                      howmany_rank: c_int,
                                      howmany_dims: *fftw_iodim64,
                                      ri: *mut c_double, ii: *mut c_double,
                                      ro: *mut c_double, io: *mut c_double,
    ...
    pub fn fftw_plan_dft_c2r_3d(n0: c_int, n1: c_int, n2: c_int,
                                ...
                                flags: c_uint) -> fftw_plan;
    pub fn fftw_plan_guru_dft_r2c(rank: c_int, dims: *fftw_iodim,
                                  howmany_rank: c_int,
                                  howmany_dims: *fftw_iodim,
                                  _in: *mut c_double, out: *mut fftw_complex,
                                  flags: c_uint) -> fftw_plan;
    pub fn fftw_plan_guru_dft_c2r(rank: c_int, dims: *fftw_iodim,
                                  howmany_rank: c_int,
                                  howmany_dims: *fftw_iodim,
                                  _in: *mut fftw_complex, out: *mut c_double,
                                  flags: c_uint) -> fftw_plan;
    pub fn fftw_plan_guru_split_dft_r2c(rank: c_int, dims: *fftw_iodim,
                                        howmany_rank: c_int,
                                        howmany_dims: *fftw_iodim,
                                        _in: *mut c_double, ro: *mut c_double,
                                        io: *mut c_double, flags: c_uint) ->
     fftw_plan;
    pub fn fftw_plan_guru_split_dft_c2r(rank: c_int, dims: *fftw_iodim,
                                        howmany_rank: c_int,
                                        howmany_dims: *fftw_iodim,
                                        ri: *mut c_double, ii: *mut c_double,
                                        out: *mut c_double, flags: c_uint) ->
     fftw_plan;
    pub fn fftw_plan_guru64_dft_r2c(rank: c_int, dims: *fftw_iodim64,
                                    howmany_rank: c_int,
                                    howmany_dims: *fftw_iodim64,
                                    _in: *mut c_double,
                                    out: *mut fftw_complex, flags: c_uint) ->
     fftw_plan;
    pub fn fftw_plan_guru64_dft_c2r(rank: c_int, dims: *fftw_iodim64,
                                    howmany_rank: c_int,
                                    howmany_dims: *fftw_iodim64,
                                    _in: *mut fftw_complex,
                                    out: *mut c_double, flags: c_uint) ->
     fftw_plan;
    pub fn fftw_plan_guru64_split_dft_r2c(rank: c_int, dims: *fftw_iodim64,
                                          howmany_rank: c_int,
                                          howmany_dims: *fftw_iodim64,
                                          _in: *mut c_double,
                                          ro: *mut c_double,
                                          io: *mut c_double, flags: c_uint) ->
     fftw_plan;
    pub fn fftw_plan_guru64_split_dft_c2r(rank: c_int, dims: *fftw_iodim64,
                                          howmany_rank: c_int,
                                          howmany_dims: *fftw_iodim64,
                                          ri: *mut c_double,
                                          ii: *mut c_double,
    ...
    pub fn fftw_plan_many_r2r(rank: c_int, n: *c_int, howmany: c_int,
                              _in: *mut c_double, inembed: *c_int,
                              istride: c_int, idist: c_int,
                              out: *mut c_double, onembed: *c_int,
                              ostride: c_int, odist: c_int,
                              kind: *fftw_r2r_kind, flags: c_uint) ->
     fftw_plan;
    pub fn fftw_plan_r2r(rank: c_int, n: *c_int, _in: *mut c_double,
                         out: *mut c_double, kind: *fftw_r2r_kind,
                         flags: c_uint) -> fftw_plan;
    ...
    pub fn fftw_plan_guru_r2r(rank: c_int, dims: *fftw_iodim,
                              howmany_rank: c_int, howmany_dims: *fftw_iodim,
                              _in: *mut c_double, out: *mut c_double,
                              kind: *fftw_r2r_kind, flags: c_uint) ->
     fftw_plan;
    pub fn fftw_plan_guru64_r2r(rank: c_int, dims: *fftw_iodim64,
                                howmany_rank: c_int,
                                howmany_dims: *fftw_iodim64,
                                _in: *mut c_double, out: *mut c_double,
                                kind: *fftw_r2r_kind, flags: c_uint) ->
    ...
    pub fn fftw_export_wisdom_to_filename(filename: *c_schar) -> c_int;
    ...
    pub fn fftw_import_wisdom_from_filename(filename: *c_schar) -> c_int;
    pub fn fftw_import_wisdom_from_file(input_file: *mut FILE) -> c_int;
    pub fn fftw_import_wisdom_from_string(input_string: *c_schar) -> c_int;
    ...
    pub fn fftwf_plan_many_dft(rank: c_int, n: *c_int, howmany: c_int,
                               ...
                               ostride: c_int, odist: c_int, sign: c_int,
                               flags: c_uint) -> fftwf_plan;
    pub fn fftwf_plan_guru_dft(rank: c_int, dims: *fftwf_iodim,
                               howmany_rank: c_int,
                               howmany_dims: *fftwf_iodim,
                               _in: *mut fftwf_complex,
                               out: *mut fftwf_complex, sign: c_int,
                               flags: c_uint) -> fftwf_plan;
    pub fn fftwf_plan_guru_split_dft(rank: c_int, dims: *fftwf_iodim,
                                     howmany_rank: c_int,
                                     howmany_dims: *fftwf_iodim,
                                     ri: *mut c_float, ii: *mut c_float,
                                     ro: *mut c_float, io: *mut c_float,
                                     flags: c_uint) -> fftwf_plan;
    pub fn fftwf_plan_guru64_dft(rank: c_int, dims: *fftwf_iodim64,
                                 howmany_rank: c_int,
                                 howmany_dims: *fftwf_iodim64,
                                 _in: *mut fftwf_complex,
                                 out: *mut fftwf_complex, sign: c_int,
                                 flags: c_uint) -> fftwf_plan;
    pub fn fftwf_plan_guru64_split_dft(rank: c_int, dims: *fftwf_iodim64,
                                       howmany_rank: c_int,
                                       howmany_dims: *fftwf_iodim64,
                                       ri: *mut c_float, ii: *mut c_float,
                                       ro: *mut c_float, io: *mut c_float,
    ...
    pub fn fftwf_plan_dft_c2r_3d(n0: c_int, n1: c_int, n2: c_int,
                                 _in: *mut fftwf_complex, out: *mut c_float,
                                 flags: c_uint) -> fftwf_plan;
    pub fn fftwf_plan_guru_dft_r2c(rank: c_int, dims: *fftwf_iodim,
                                   howmany_rank: c_int,
                                   howmany_dims: *fftwf_iodim,
                                   _in: *mut c_float, out: *mut fftwf_complex,
                                   flags: c_uint) -> fftwf_plan;
    pub fn fftwf_plan_guru_dft_c2r(rank: c_int, dims: *fftwf_iodim,
                                   howmany_rank: c_int,
                                   howmany_dims: *fftwf_iodim,
                                   _in: *mut fftwf_complex, out: *mut c_float,
                                   flags: c_uint) -> fftwf_plan;
    pub fn fftwf_plan_guru_split_dft_r2c(rank: c_int, dims: *fftwf_iodim,
                                         howmany_rank: c_int,
                                         howmany_dims: *fftwf_iodim,
                                         _in: *mut c_float, ro: *mut c_float,
                                         io: *mut c_float, flags: c_uint) ->
     fftwf_plan;
    pub fn fftwf_plan_guru_split_dft_c2r(rank: c_int, dims: *fftwf_iodim,
                                         howmany_rank: c_int,
                                         howmany_dims: *fftwf_iodim,
                                         ri: *mut c_float, ii: *mut c_float,
                                         out: *mut c_float, flags: c_uint) ->
     fftwf_plan;
    pub fn fftwf_plan_guru64_dft_r2c(rank: c_int, dims: *fftwf_iodim64,
                                     howmany_rank: c_int,
                                     howmany_dims: *fftwf_iodim64,
                                     _in: *mut c_float,
                                     out: *mut fftwf_complex, flags: c_uint)
     -> fftwf_plan;
    pub fn fftwf_plan_guru64_dft_c2r(rank: c_int, dims: *fftwf_iodim64,
                                     howmany_rank: c_int,
                                     howmany_dims: *fftwf_iodim64,
                                     _in: *mut fftwf_complex,
                                     out: *mut c_float, flags: c_uint) ->
     fftwf_plan;
    pub fn fftwf_plan_guru64_split_dft_r2c(rank: c_int, dims: *fftwf_iodim64,
                                           howmany_rank: c_int,
                                           howmany_dims: *fftwf_iodim64,
                                           _in: *mut c_float,
                                           ro: *mut c_float, io: *mut c_float,
                                           flags: c_uint) -> fftwf_plan;
    pub fn fftwf_plan_guru64_split_dft_c2r(rank: c_int, dims: *fftwf_iodim64,
                                           howmany_rank: c_int,
                                           howmany_dims: *fftwf_iodim64,
                                           ri: *mut c_float, ii: *mut c_float,
                                           out: *mut c_float, flags: c_uint)
    ...
    pub fn fftwf_plan_many_r2r(rank: c_int, n: *c_int, howmany: c_int,
                               _in: *mut c_float, inembed: *c_int,
                               istride: c_int, idist: c_int,
                               out: *mut c_float, onembed: *c_int,
                               ostride: c_int, odist: c_int,
     ...
     fftwf_plan;
    pub fn fftwf_plan_r2r(rank: c_int, n: *c_int, _in: *mut c_float,
                          out: *mut c_float, kind: *fftwf_r2r_kind,
                          flags: c_uint) -> fftwf_plan;
    ...
    pub fn fftwf_plan_r2r_3d(n0: c_int, n1: c_int, n2: c_int,
     ...
     fftwf_plan;
    pub fn fftwf_plan_guru_r2r(rank: c_int, dims: *fftwf_iodim,
                               howmany_rank: c_int,
                               howmany_dims: *fftwf_iodim, _in: *mut c_float,
                               out: *mut c_float, kind: *fftwf_r2r_kind,
                               flags: c_uint) -> fftwf_plan;
    pub fn fftwf_plan_guru64_r2r(rank: c_int, dims: *fftwf_iodim64,
                                 howmany_rank: c_int,
                                 howmany_dims: *fftwf_iodim64,
                                 _in: *mut c_float, out: *mut c_float,
                                 kind: *fftwf_r2r_kind, flags: c_uint) ->
    ...
    pub fn fftwf_export_wisdom_to_filename(filename: *c_schar) -> c_int;
    ...
    pub fn fftwf_import_wisdom_from_filename(filename: *c_schar) -> c_int;
    pub fn fftwf_import_wisdom_from_file(input_file: *mut FILE) -> c_int;
    pub fn fftwf_import_wisdom_from_string(input_string: *c_schar) -> c_int;
    ...
    pub fn fftwl_plan_many_dft(rank: c_int, n: *c_int, howmany: c_int,
                               ...
                               ostride: c_int, odist: c_int, sign: c_int,
                               flags: c_uint) -> fftwl_plan;
    pub fn fftwl_plan_guru_dft(rank: c_int, dims: *fftwl_iodim,
                               howmany_rank: c_int,
                               howmany_dims: *fftwl_iodim,
                               _in: *mut fftwl_complex,
                               out: *mut fftwl_complex, sign: c_int,
                               flags: c_uint) -> fftwl_plan;
    pub fn fftwl_plan_guru_split_dft(rank: c_int, dims: *fftwl_iodim,
                                     howmany_rank: c_int,
                                     howmany_dims: *fftwl_iodim,
                                     ri: *mut c_double, ii: *mut c_double,
                                     ro: *mut c_double, io: *mut c_double,
                                     flags: c_uint) -> fftwl_plan;
    pub fn fftwl_plan_guru64_dft(rank: c_int, dims: *fftwl_iodim64,
                                 howmany_rank: c_int,
                                 howmany_dims: *fftwl_iodim64,
                                 _in: *mut fftwl_complex,
                                 out: *mut fftwl_complex, sign: c_int,
                                 flags: c_uint) -> fftwl_plan;
    pub fn fftwl_plan_guru64_split_dft(rank: c_int, dims: *fftwl_iodim64,
                                       howmany_rank: c_int,
                                       howmany_dims: *fftwl_iodim64,
                                       ri: *mut c_double, ii: *mut c_double,
                                       ro: *mut c_double, io: *mut c_double,
    ...
    pub fn fftwl_plan_dft_c2r_3d(n0: c_int, n1: c_int, n2: c_int,
                                 _in: *mut fftwl_complex, out: *mut c_double,
                                 flags: c_uint) -> fftwl_plan;
    pub fn fftwl_plan_guru_dft_r2c(rank: c_int, dims: *fftwl_iodim,
                                   howmany_rank: c_int,
                                   howmany_dims: *fftwl_iodim,
                                   _in: *mut c_double,
                                   out: *mut fftwl_complex, flags: c_uint) ->
     fftwl_plan;
    pub fn fftwl_plan_guru_dft_c2r(rank: c_int, dims: *fftwl_iodim,
                                   howmany_rank: c_int,
                                   howmany_dims: *fftwl_iodim,
                                   _in: *mut fftwl_complex,
                                   out: *mut c_double, flags: c_uint) ->
     fftwl_plan;
    pub fn fftwl_plan_guru_split_dft_r2c(rank: c_int, dims: *fftwl_iodim,
                                         howmany_rank: c_int,
                                         howmany_dims: *fftwl_iodim,
                                         _in: *mut c_double,
                                         ro: *mut c_double, io: *mut c_double,
                                         flags: c_uint) -> fftwl_plan;
    pub fn fftwl_plan_guru_split_dft_c2r(rank: c_int, dims: *fftwl_iodim,
                                         howmany_rank: c_int,
                                         howmany_dims: *fftwl_iodim,
                                         ri: *mut c_double, ii: *mut c_double,
                                         out: *mut c_double, flags: c_uint) ->
     fftwl_plan;
    pub fn fftwl_plan_guru64_dft_r2c(rank: c_int, dims: *fftwl_iodim64,
                                     howmany_rank: c_int,
                                     howmany_dims: *fftwl_iodim64,
                                     _in: *mut c_double,
                                     out: *mut fftwl_complex, flags: c_uint)
     -> fftwl_plan;
    pub fn fftwl_plan_guru64_dft_c2r(rank: c_int, dims: *fftwl_iodim64,
                                     howmany_rank: c_int,
                                     howmany_dims: *fftwl_iodim64,
                                     _in: *mut fftwl_complex,
                                     out: *mut c_double, flags: c_uint) ->
     fftwl_plan;
    pub fn fftwl_plan_guru64_split_dft_r2c(rank: c_int, dims: *fftwl_iodim64,
                                           howmany_rank: c_int,
                                           howmany_dims: *fftwl_iodim64,
                                           _in: *mut c_double,
                                           ro: *mut c_double,
                                           io: *mut c_double, flags: c_uint)
     -> fftwl_plan;
    pub fn fftwl_plan_guru64_split_dft_c2r(rank: c_int, dims: *fftwl_iodim64,
                                           howmany_rank: c_int,
                                           howmany_dims: *fftwl_iodim64,
                                           ri: *mut c_double,
                                           ii: *mut c_double,
    ...
    pub fn fftwl_execute_split_dft_c2r(p: fftwl_plan, ri: *mut c_double,
                                       ii: *mut c_double, out: *mut c_double);
    pub fn fftwl_plan_many_r2r(rank: c_int, n: *c_int, howmany: c_int,
                               _in: *mut c_double, inembed: *c_int,
                               istride: c_int, idist: c_int,
                               out: *mut c_double, onembed: *c_int,
                               ostride: c_int, odist: c_int,
     ...
     fftwl_plan;
    pub fn fftwl_plan_r2r(rank: c_int, n: *c_int, _in: *mut c_double,
                          out: *mut c_double, kind: *fftwl_r2r_kind,
                          flags: c_uint) -> fftwl_plan;
    ...
    pub fn fftwl_plan_r2r_3d(n0: c_int, n1: c_int, n2: c_int,
     ...
     fftwl_plan;
    pub fn fftwl_plan_guru_r2r(rank: c_int, dims: *fftwl_iodim,
                               howmany_rank: c_int,
                               howmany_dims: *fftwl_iodim, _in: *mut c_double,
                               out: *mut c_double, kind: *fftwl_r2r_kind,
                               flags: c_uint) -> fftwl_plan;
    pub fn fftwl_plan_guru64_r2r(rank: c_int, dims: *fftwl_iodim64,
                                 howmany_rank: c_int,
                                 howmany_dims: *fftwl_iodim64,
                                 _in: *mut c_double, out: *mut c_double,
                                 kind: *fftwl_r2r_kind, flags: c_uint) ->
    ...
    pub fn fftwl_export_wisdom_to_filename(filename: *c_schar) -> c_int;
    ...
    pub fn fftwl_import_wisdom_from_filename(filename: *c_schar) -> c_int;
    pub fn fftwl_import_wisdom_from_file(input_file: *mut FILE) -> c_int;
    pub fn fftwl_import_wisdom_from_string(input_string: *c_schar) -> c_int;
